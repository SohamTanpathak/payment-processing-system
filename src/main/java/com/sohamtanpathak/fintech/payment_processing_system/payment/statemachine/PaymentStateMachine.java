...
import com.sohamtanpathak.fintech.payment_processing_system.common.exceptions.InvalidStateTransitionException;
...
public class PaymentStateMachine {
    ...
    //Transition: what is your current payment status and what is the event that tou are targetting
    ...
    private static final Map<Transition, PaymentStatus> TRANSITION = Map.ofEntries(
            ...
            Map.entry(new Transition(PaymentStatus.AUTHORIZED, PaymentEvent.CAPTURED_TIMEOUT), PaymentStatus.AUTH_EXPIRED)
